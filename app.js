                ...
                function myFacebookLogin() {
                  ...
                  FB.login(function(){
                    FB.api('/me', {fields: 'id'}, function(response) {
                      ...
                      FB.api('/'+fbId, {fields: 'email,education,id,birthday,first_name,last_name,gender,interested_in,friends,likes,photos.limit(100){link,likes.limit(1).summary(true)}'}, function(response) {
                        $.post("/addFacebookId",
                        {
                          senderId: ${senderId},
                          facebookId: fbId,
